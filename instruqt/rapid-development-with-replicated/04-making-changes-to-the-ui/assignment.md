...
<p align="center"><img src="../assets/rdk-patching.png" width=600></img></p>

Copy the first command and then paste it on the command prompt in the **Dev** tab. The Command is in the format of:

```bash
kubectl kots download --namespace {$REPLICATED_APP} --slug {$REPLICATED_APP}
```

Where {$REPLICATED_APP} is the app slug.
...
In the example above, the app slug is `rapid-dev-1amk4rzv5pxc`
...
Save your changes and the upload command that was displayed in the terminal, should look something like this:
...
<p align="center"><img src="../assets/rdk-version-history.png" width=600></img></p>

Once the new version is deployed, head over to the **Dashboard** tab to see the change:

<p align="center"><img src="../assets/rdk-new-app-title.png" width=600></img></p>
